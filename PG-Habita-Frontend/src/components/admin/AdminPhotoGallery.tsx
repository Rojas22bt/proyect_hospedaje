  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30">
      <div className="container mx-auto p-6 space-y-6">
        ...
        {/* Carrusel de fotos - SIMPLIFICADO PARA DEBUG */}
        {isCarouselOpen && selectedPropiedad && (
          <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg p-6 max-w-4xl w-full max-h-[90vh] overflow-auto">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold">Carrusel de Fotos - {selectedPropiedad.nombre}</h2>
                <Button onClick={closeCarousel} variant="outline">
...
// Componente de carrusel simplificado
function PhotoCarouselContent({ propiedad, onDeleteFile }: any) {
  ...
  if (isLoading) {
    return <div className="text-center p-8">Cargando fotos...</div>;
  }

  if (files.length === 0) {
    return <div className="text-center p-8">No hay fotos para esta propiedad</div>;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <Button onClick={prevImage} disabled={files.length <= 1}>
        ...
        <Button onClick={nextImage} disabled={files.length <= 1}>
          Siguiente
      ...
      <div className="flex justify-center">
        <div className="relative">
          <img
            src={currentFile.archivo_url || currentFile.archivo}
            alt={`${propiedad.nombre} - Foto ${currentIndex + 1}`}
      ...
      {currentFile && (
        <div className="text-center text-sm text-gray-600">
          <p>{currentFile.nombre_archivo}</p>
          {currentFile.tamanio && (
            <p>Tamaño: {(currentFile.tamanio / 1024 / 1024).toFixed(2)} MB</p>
          )}
        </div>
      )}
    </div>
